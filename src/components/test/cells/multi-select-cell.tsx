...
interface MultiSelectCellProps {
    ...
    /* If true, users can select multiple values. */
...
const Editor: ReturnType<ProvideEditorCallback<MultiSelectCell>> = p => {
    ...
    const { options: optionsIn, values: valuesIn, allowCreation, allowDuplicates, isMulti = true } = cell.data;
            ...
            <SelectComponent
                ...
                onChange={async e => {
                    ...
                    if (isMulti) {
                        ...
                        // For single select, take only the last value
                        submitValues([e.value]);
                    }
                }}
            />
        </Wrap>
